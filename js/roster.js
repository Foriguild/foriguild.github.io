            ...
            /*if (jQuery.isEmptyObject(library)) {
                ...
                jQuery.each(guild.members, function     (i, val) {
                    ...
                    if (val.character.level == "100") {
                        ...
                        if (val.character.class == "1") {val.character.class = "Guerrero"; classColor = "#C79C6E"};
                        if (val.character.class == "2") {val.character.class = "Paladín"; classColor = "#F58CBA"};
                        if (val.character.class == "3") {val.character.class = "Cazador"; classColor = "#ABD473"};
                        if (val.character.class == "4") {val.character.class = "Pícaro"; classColor = "#FFF569"};
                        if (val.character.class == "5") {val.character.class = "Sacerdote"; classColor = "gray"};
                        if (val.character.class == "6") {val.character.class = "Caballero de la Muerte"; classColor = "#C41F3B"};
                        if (val.character.class == "7") {val.character.class = "Chamán"; classColor = "#0070DE"};
                        if (val.character.class == "8") {val.character.class = "Mago"; classColor = "#69CCF0"};
                        if (val.character.class == "9") {val.character.class = "Brujo"; classColor = "#9482C9"};
                        if (val.character.class == "10") {val.character.class = "Monje"; classColor = "#00FF96"};
                        if (val.character.class == "11") {val.character.class = "Druida"; classColor = "#FF7D0A"};

                        $('#members').append('<tr><td style="border-right:' + classColor + ' solid 10px;"><a href="http://eu.battle.net/wow/es/character/' + val.character.realm 
                                    + '/' + val.character.name + '/simple">' + val.character.name + '</a></td><td>' + val.character.class + '</td><td>'
                                 + val.character.level + '</td><td>' + val.character.realm + '</td><td id="' + val.character.name + 'Ilvl"></td></tr>');
